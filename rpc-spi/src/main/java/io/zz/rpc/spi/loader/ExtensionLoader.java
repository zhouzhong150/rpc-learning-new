...
public final class ExtensionLoader<T> {
    ...
    private static final String ZZ_DIRECTORY = "META-INF/zz/";
    private static final String ZZ_DIRECTORY_EXTERNAL = "META-INF/zz/external/";
    private static final String ZZ_DIRECTORY_INTERNAL = "META-INF/zz/internal/";

    private static final String[] SPI_DIRECTORIES = new String[]{
            SERVICES_DIRECTORY,
            ZZ_DIRECTORY,
            ZZ_DIRECTORY_EXTERNAL,
            ZZ_DIRECTORY_INTERNAL
    };
